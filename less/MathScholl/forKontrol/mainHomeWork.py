...
listDown = 200
primerOnPage = 170
maxRange = ((primerOnPage + 1) * listDown) - listDown + 1

canvas = createPDF(path,'Деление без остатка хх хх (HomeWork)')
xStart = 29.7
yStart = 2.5
...
for i in range(1, maxRange):
    primerOnPageCount = primerOnPageCount + 1
    ...
    if primerOnPageCount == primerOnPage and maxRange - i > primerOnPage:
        canvas.showPage()
        x = 29.7-1.5
        y = 3.24
        primerOnPageCount = 0
